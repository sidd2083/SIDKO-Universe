...
export default function Settings() {
  ...
  const statusPresets: Array<{ label: string; emoji: string }> = [
    { label: 'Building StudentHub', emoji: '💻' },
    { label: 'Studying for exams', emoji: '📚' },
    { label: 'At the Gym', emoji: '💪' },
    { label: 'Playing games', emoji: '🎮' },
    { label: 'Sleeping 😴', emoji: '😴' },
    { label: 'Learning AI/ML', emoji: '🤖' },
    { label: 'Listening to music', emoji: '🎵' },
    { label: 'Out with friends', emoji: '🤝' },
        ...
        <form onSubmit={handleSave} className="bg-card border border-border rounded-3xl p-8 space-y-8 shadow-sm">
          ...
          <div>
            ...
            <div className="flex gap-2 mb-3">
              <span className="flex items-center justify-center w-12 h-12 bg-background border border-border rounded-xl text-2xl">
